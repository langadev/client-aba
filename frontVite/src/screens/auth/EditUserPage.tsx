...
import {
  ...
  upsertChildHealth,
  type ChildHealthDTO,
} from "@/service/childHealthService";
import {
  getChildSchool,
  upsertChildSchool,
  type ChildSchoolDTO,
} from "@/service/childSchoolService";
...
const EditUserPage: React.FC = () => {
  ...
  const redirectByRole = () => {
    ...
    else if (userRole === "PAI") navigate("/parent");
    else if (userRole === "PSICOLOGO") navigate("/psychologist/dashboard");
    else navigate("/");
  };

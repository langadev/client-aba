// src/screens/psychologist/PsychologistDashboard.tsx
...
import ManageChildren from "@/screens/Psychologist/PsychologistChildren";
import ManageUsers from "@/screens/admin/ManageUsers";
import Sessions from "./PsychologistSessions";
import Reports from "@/screens/reports/reports";
import Messages from "@/screens/messages/messages";
import PsychologistChildDash from "./PyschologittChildDash";
...
const PisychologistSideBar = (): JSX.Element => {
  const [currentScreen, setCurrentScreen] = useState<Screen>("dashboard");
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
  const { user, logout } = useAuthStore();

  // Trava o scroll do body ao abrir o drawer
  useEffect(() => {
  ...
  const NavigationSection = ({
    ...
    const menuItems = [
      ...
      // extras opcionais para o psicólogo
      ...
      <>
        ...
        <nav
          ...
          className={cn(
            ...
            // MOBILE: drawer que aparece abaixo do header fixo (top-16)
            !isDesktop &&
        ...
        >
          ...
          <div className={cn("flex items-center justify-between px-4 border-b", isDesktop ? "h-14" : "h-16")}>
            <div>
              <h1 className="text-base lg:text-lg font-bold text-gray-900">Portal do Psicólogo</h1>
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      {/* Header fixo (já responsivo com ícone do utilizador à direita) */}
      <HeaderSection />
...
export default PisychologistSideBar;

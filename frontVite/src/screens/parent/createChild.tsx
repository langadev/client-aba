...
import { createChild, getParents, getPsychologists } from "../../service/childService";
import { 
  ArrowLeft, 
  Save, 
  User, 
...
const CreateChildPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setParents(parentsData.data || parentsData);
        setPsychologists(psychologistsData.data || psychologistsData);
      } catch (error: any) {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    const numericValue = name === "parentId" || name === "psychologistId" 
      ? parseInt(value) || 0 
      : value;
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-blue-800">Idade Estimada</p>

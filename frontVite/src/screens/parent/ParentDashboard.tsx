      ...
      <>
        ...
        >
          ...
          <div className={cn("flex items-center justify-between px-4 border-b", isDesktop ? "h-14" : "h-16")}>
            <div>
              <h1 className="text-base lg:text-lg font-bold text-gray-900">Portal dos Pais</h1>
          ...
          <div className="border-t border-gray-200 p-4 sticky bottom-0 bg-white">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-900 truncate">{user?.name ?? "Utilizador"}</p>
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="flex flex-1 pt-16">
        ...
        <div className="hidden lg:block lg:fixed lg:left-0 lg:top-16 lg:w-64 lg:h-[calc(100vh-4rem)] lg:bg-white lg:border-r lg:border-gray-200 lg:z-30">
          <NavigationSection currentScreen={currentScreen} onScreenChange={setCurrentScreen} variant="desktop" />
        </div>

        {/* Drawer mobile (instância separada) */}
        <div className="lg:hidden">
          <NavigationSection currentScreen={currentScreen} onScreenChange={setCurrentScreen} variant="mobile" />
        </div>

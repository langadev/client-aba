...
import { getConsultations, type Consultation } from "../../../api/repository/consultaionRepository";
          ...
          <div className="overflow-x-auto bg-white border rounded-xl">
            <table className="table-auto w-full text-sm">
                ...
                <tr className="text-left text-sm text-gray-600">
                  ...
                  <th className="p-3 min-w-[120px]">Data</th>
                  <th className="p-3 min-w-[100px]">Hora</th>
                  <th className="p-3 min-w-[150px]">Criança</th>
                  <th className="p-3 min-w-[150px]">Psicólogo</th>
                    ...
                    <tr key={c.id} className="border-t text-sm align-middle">
                      ...
                      <td className="p-3">
                        <div className="inline-flex items-center gap-2">
                          ...
                          <span title={childName} className="truncate max-w-[220px] inline-block align-middle">
                            {childName}
                          </span>
                        </div>
                      </td>
                      <td className="p-3">
                        <div className="inline-flex items-center gap-2">
                          ...
                          <span title={psyName} className="truncate max-w-[220px] inline-block align-middle">
                            {psyName}
                          </span>
                        </div>
                      </td>
